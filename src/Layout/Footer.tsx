...
import { Instagram, Twitter, Linkedin, Github, Phone, Mail, MapPin } from "lucide-react";
            ...
            <div className="col-span-full lg:col-span-2">
              ...
              <div className="flex flex-col space-y-2 text-gray-500">
                ...
                <div className="flex items-start">
                  ...
                  <span>JSS Science & Tech Entrepreneurs Park (STEP) C-20/I, Sector 62, NOIDA - 201301, UP</span>
                </div>
              </div>
            </div>
                ...
                <nav className="flex flex-col gap-4">
                  {section.links.map((link, linkIndex) => (
                    <div key={linkIndex}>
                      <Link
                        to={link.to}
                        className="text-foreground/50 transition duration-100 hover:text-primary active:text-primary"
                      >
                        {link.title}
                      </Link>
                    </div>
