...
import img1 from "../../assets/AboutUs/Sandeep.png";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {visibleTestimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="bg-white rounded-lg shadow-md p-8 transition-transform duration-300 hover:scale-105 flex flex-col h-full"
            >
              <div className="flex items-center mb-6">
                <img
                  src={testimonial.avatar}
                  alt={testimonial.name}
                  className="w-16 h-16 rounded-full mr-4 border-2 border-primary shadow-lg"
                />
                <div>
              ...
              <div className="relative">
                <span className="text-primary text-4xl absolute -top-4 -left-2">
                  "
                </span>
                <p className="text-muted-foreground leading-relaxed pt-2 px-4 italic">
                  {testimonial.content}
                </p>
                <span className="text-primary text-4xl absolute bottom-0 right-0">
                  "
                </span>
              </div>
            </motion.div>
